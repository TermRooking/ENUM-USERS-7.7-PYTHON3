...
import argparse, logging, paramiko, socket, sys, os,time
...
parser.add_argument('-t','--target', dest="target" , help="IP address of the target system",required=True)
parser.add_argument('-p', '--port', dest="port" ,default=22, help="Set port of SSH service")
parser.add_argument('-u','--username', dest="username", help="Username to check for validity.")
